      ...
      <div class="feeds">
        <div class="feed">
          <div class="head">
            ...
            <span id="edit">
              <button class="btn btn-transparent"><i class="uil uil-ellipsis-h"></i></button>
                        </span>
          </div>
    ...
    <div class="right">
      <div class="side-profile">
        ...
        <div class="bio">
          ...
          <div class="bio-body">
            <h5 class="tex-bold">Living in </h5>
            <div class="text-muted">
  ...
  <div class="card">
    ...
    <div class="color">
      ...
      <div class="choose-color">
        ...
        <span class="color-{ $color.id } {if $color.active}active{/if}"></span>
        {/foreach}
      </div>
    </div>
    ...
    <div class="background">
      ...
      <div class="choose-bg">
        ...
        <div class="bg-{ $bg.id } {if $bg.active}active{/if}">
          <span></span>
          <h5>{ $bg.name }</h5>
        </div>
        {/foreach}
