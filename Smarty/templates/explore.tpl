    ...
    <div class="middle">
      ...
      <div class="feeds">
        <div class="feed">
          ...
          <div class="caption ">
            <p><b>{$feedUsername}</b> {$feedContent} <span class="harsh-tag">
                        freestar
          ...
          <div class="liked-by">
            <span><img src="{$likedUser['photo']} alt="></span>
            {/foreach}
            <p> liked by <b>{$feedLikeByUser}</b> and <b>{$feedOtherLikes}</b></p>
          </div>
      ...
      <div class="top-writer">
        ...
        <div class="writer">
          ...
          <div class="info">
            ...
            <div>
              <h5>{$writer.name}</h5>
              <p class="text-muted">{$writer.like}</p>
            </div>
          </div>
          {/foreach}
        </div>
...
<div class="report">
  <div class="card">
    ...
    <form>
      ...
      <label>
        <button type="button" class="btn btn-primary" style="margin-top: 1%">Cancel</button>
      </label>
    </form>
  </div>
</div>
