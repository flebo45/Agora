<?php
/* Smarty version 3.1.33, created on 2023-09-09 18:22:43
  from 'C:\xampp\htdocs\Agora\Smarty\templates\userlist.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_64fc9bd38c3372_43021255',
...
function content_64fc9bd38c3372_43021255 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
" class="vip"><?php echo $_smarty_tpl->tpl_vars['l']->value->getUsername();?>
                            ...
                            <?php } else { ?>
                                <i class="uil uil-accessible-icon-alt" style="color:red; margin-left:1rem"></i> <a href="/Agora/User/profile/<?php echo $_smarty_tpl->tpl_vars['l']->value->getUsername();?>
" class="tex-bold" style="text-decoration: none; color: inherit"><?php echo $_smarty_tpl->tpl_vars['l']->value->getUsername();?>
</a>
                            <?php }?>
                            <p class="text-muted left-transition"> <?php echo $_smarty_tpl->tpl_vars['l']->value->getName();?>
