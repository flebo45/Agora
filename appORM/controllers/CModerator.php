...
class CModerator{
    ...
    public static function banPost($idPost, $idUser){
        if(CModerator::isLogged()){
            ...
            if($post !== null){
                ...
                FPersistentManager::getInstance()->deleteRelatedReports($idPost, 'post');
    ...
    public static function banComment($idComment){
        if(CModerator::isLogged()){
            ...
            if($comment !== null){
                ...
                FPersistentManager::getInstance()->deleteRelatedReports($idComment, 'comment');
            }
            header('Location: /Agora/Moderator/reportList');
        }
    }
    ...
    public static function visitUser($id)
    {
        ...
        if(CModerator::isLogged()){
            ...
            if($user !== null){
                ...
                $userPosts = FPersistentManager::getInstance()->loadUserPage($user);
    ...
    public static function visitPost($id)
    {
        if(CModerator::isLogged()){
            ...
            $post = FPersistentManager::getInstance()->retriveObj(EPost::getEntity(), $id);
            if($post !== null){
